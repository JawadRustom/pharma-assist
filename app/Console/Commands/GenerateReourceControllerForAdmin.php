...
class GenerateReourceControllerForAdmin extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:res-controller-admin {name}';
     ...
     * @var string
     */
    protected $description = 'Generates a resource controller with Api reource and requests for Admin to AdminDashboard';
...
class Store' . $name . 'Request extends FormRequest
{
  /**
    ...
    ';
        $this->file_force_contents('app/Http/Requests/Api/V1/AdminDashboard/Admin/' . $name . 'Request/Store' . $name . 'Request.php', $stroeRequestContents);
...
class Update' . $name . 'Request extends FormRequest
{
  /**
    ...
    ';
        $this->file_force_contents('app/Http/Requests/Api/V1/AdminDashboard/Admin/' . $name . 'Request/Update' . $name . 'Request.php', $updateRequestContents);
...
class ' . $name . 'Resource extends JsonResource
{
    ...
    ';
        $this->file_force_contents('app/Http/Resources/Api/V1/AdminDashboard/Admin/' . $name . 'Resource/' . $name . 'Resource.php', $resourceContents);
        $this->info('Resource has been created: app/Http/Resources/Api/V1/AdminDashboard/Admin/' . $name . 'Resource/' . $name . 'Resource.php');
    }
